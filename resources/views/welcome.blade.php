...
@section('body')
    ...
    <div class="bg-cover h-screen" v-bind:style="{ backgroundImage: 'url(https://images.unsplash.com/photo-1489710437720-ebb67ec84dd2?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=2fe1fcbff362a3ba7a8eed548f81430b&auto=format&fit=crop&w=1650&q=80)' }">
